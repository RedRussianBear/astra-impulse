...
sprite.Sprite.prototype = {
    get momentum() {
        return this.veloc.times(mass);
    },
    get accel() {
        return this.getaccel(this.pos)
    },
    get pwidth() {
        return sprite.SCALE * this.width;
    },
    get pheight() {
        return sprite.SCALE * this.height;
    },
    get mass() {
        return this.masss + math.sum(this.children, "mass");
    },
    getaccel(pos) {
