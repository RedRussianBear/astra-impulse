...
input.inputHandler.prototype = {
	start() {
		...
		document.onkeydown = function(e) { inputh.keyhandle(e); }
		document.onkeyup = function(e) { inputh.keyhandle(e); }
		
		this.engine.canvas.onmousedown = function(e) { inputh.mousehandle(e); }
		this.engine.canvas.onmouseup = function(e) { inputh.mousehandle(e); }
		this.engine.canvas.onmousemove = function(e) { inputh.mousehandle(e); }
	},
